...
class ProductSkuSeeder extends Seeder
{
  ...
  public function run(): void
  {
    ...
    $model = ProductSku::class;
    $seeding_file_name = storage_path('database_seeding_files/' . 'product_skus.tsv');
    ...
    $columns = [
      ...
      SeederHelper::getColumnDefinition('price', 'Price'),
      SeederHelper::getColumnDefinition('stock', 'Stock'),
